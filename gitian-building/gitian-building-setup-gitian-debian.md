...
```bash
cd gitian-builder
bin/make-base-vm --lxc --arch amd64 --suite focal --disksize 13000 # For releases after and including 22.0
bin/make-base-vm --lxc --arch amd64 --suite bionic # For supported releases before 22.0
```
